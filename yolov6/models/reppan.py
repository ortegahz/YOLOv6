...
from yolov6.layers.common import RepBlock, RepVGGBlock, BottleRep, BepC3, ConvBNReLU, Transpose, BiFusion, \
                                MBLABlock, ConvBNHS, CSPBlock, DPBlock, BiFusionRKNN, Upsample
...
class RepBiFPANNeckRKNN(nn.Module):
    """RepBiFPANNeckRKNN Module
    """
    # [64, 128, 256, 512, 1024]
...
class RepBiFPANNeck6RKNN(nn.Module):
    """RepBiFPANNeck6RKNN Module
    """
    # [64, 128, 256, 512, 768, 1024]
    # [512, 256, 128, 256, 512, 1024]
